    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['infra:data:error-code:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['infra:data:error-code:export']"
        >
      ...
      <el-table-column label="操作" align="center" class-name="small-paddingfixed-width">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['infra:data:error-code:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['infra:data:error-code:delete']"
          >
            删除
          </el-button>
        </template>
...
<script setup lang="ts" name="InfraErrorCode">
import { DICT_TYPE, getIntDictOptions } from '@/utils/dict'
import { dateFormatter } from '@/utils/formatTime'
import download from '@/utils/download'
import * as ErrorCodeApi from '@/api/infra/data/errorCode'
