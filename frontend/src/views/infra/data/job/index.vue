      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['infra:data:job:update']"
          >
            修改
          </el-button>
          <el-button
          ...
          <el-button
            ...
            v-hasPermi="['infra:data:job:delete']"
          >
            删除
          </el-button>
          <el-dropdown
            @command="(command) => handleCommand(command, scope.row)"
            v-hasPermi="['infra:data:job:trigger', 'infra:data:job:query']"
          >
            <el-button type="primary" link><Icon icon="ep:d-arrow-right" /> 更多</el-button>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item command="handleRun" v-if="checkPermi(['infra:data:job:trigger'])">
                  执行一次
                </el-dropdown-item>
                <el-dropdown-item command="openDetail" v-if="checkPermi(['infra:data:job:query'])">
                  任务详细
                </el-dropdown-item>
                <el-dropdown-item
                  command="handleJobLog"
                  v-if="checkPermi(['infra:data:job:query'])"
                >
                  调度日志
                </el-dropdown-item>
              </el-dropdown-menu>
