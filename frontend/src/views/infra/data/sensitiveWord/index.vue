  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          v-hasPermi="['infra:data:sensitive-word:create']"
          plain
          type="primary"
        ...
        <el-button
          v-hasPermi="['infra:data:sensitive-word:export']"
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          <el-button
            v-hasPermi="['infra:data:sensitive-word:update']"
            link
            type="primary"
          ...
          <el-button
            v-hasPermi="['infra:data:sensitive-word:delete']"
            link
            type="danger"
...
<script lang="ts" name="InfraSensitiveWordHao" setup>
import { DICT_TYPE, getIntDictOptions } from '@/utils/dict'
import { dateFormatter } from '@/utils/formatTime'
import download from '@/utils/download'
import * as SensitiveWordApi from '@/api/infra/data/sensitiveWord'
