    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['infra:sms-template:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['infra:sms-template:export']"
        >
      ...
      <el-table-column label="操作" align="center" width="210" fixed="right">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['infra:sms-template:update']"
          >
            修改
          </el-button>
          <el-button
            ...
            v-hasPermi="['infra:sms-template:send-sms']"
          >
            测试
          </el-button>
          <el-button
            ...
            v-hasPermi="['infra:sms-template:delete']"
          >
            删除
          </el-button>
        </template>
