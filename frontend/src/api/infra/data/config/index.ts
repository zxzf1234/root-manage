...
export const getConfigKey = (configKey: string) => {
  return request.get({ url: '/infra/data/config/get-value-by-key?key=' + configKey })
}
...
export const deleteConfig = (id: number) => {
  return request.delete({ url: '/infra/data/config/delete?id=' + id })
}

// 导出参数
export const exportConfig = (params) => {
  return request.download({ url: '/infra/data/config/export', params })
}
