...
import cn.iocoder.yudao.service.enums.infra.errorcode.InfraErrorCodeTypeEnum;
...
import static cn.iocoder.yudao.service.errorCode.infra.ErrorCodeConstants.ERROR_CODE_DUPLICATE;
import static cn.iocoder.yudao.service.errorCode.infra.ErrorCodeConstants.ERROR_CODE_NOT_EXISTS;
...
public class ErrorCodeServiceImpl implements ErrorCodeService {
    ...
    public Long createErrorCode(ErrorCodeCreateReqVO createReqVO) {
        ...
        errorCode = SystemErrorCodeDraft.$.produce(errorCode, SystemErrorCode -> {
            SystemErrorCode.setType(InfraErrorCodeTypeEnum.MANUAL_OPERATION.getValue());
        });
        ...
        autoGenerateDTOs.forEach(autoGenerateDTO -> {
            ...
            if (systemErrorCode == null) {
                ...
                systemErrorCode = SystemErrorCodeDraft.$.produce(systemErrorCode, SystemErrorCode -> {
                    SystemErrorCode.setType(InfraErrorCodeTypeEnum.AUTO_GENERATION.getValue());
                });
            ...
            // 存在，则进行更新。更新有三个前置条件：
            // 条件 1. 只更新自动生成的错误码，即 Type 为 InfraErrorCodeTypeEnum.AUTO_GENERATION
            if (!InfraErrorCodeTypeEnum.AUTO_GENERATION.getValue().equals(systemErrorCode.type())) {
                return;
            }
