...
public interface Oauth2ClientService {
     ...
     * @return OAuth2 客户端
     */
    SystemOauth2Client getOAuth2Client(Long id);
     ...
     * @return OAuth2 客户端分页
     */
    PageResult<OAuth2ClientRespVO> getOAuth2ClientPage(OAuth2ClientPageReqVO pageReqVO);
     ...
     * @return 客户端
     */
    default SystemOauth2Client validOAuthClientFromCache(String clientId) {
     ...
     * @return 客户端
     */
    SystemOauth2Client validOAuthClientFromCache(String clientId, String clientSecret,
