...
public interface Oauth2GrantService {
     ...
     * @return 访问令牌
     */
    SystemOauth2AccessToken grantImplicit(Long userId, Integer userType,
     ...
     * @return 访问令牌
     */
    SystemOauth2AccessToken grantAuthorizationCodeForAccessToken(String clientId, String code,
                                                             String redirectUri, String state);
     ...
     * @return 访问令牌
     */
    SystemOauth2AccessToken grantPassword(String username, String password,
                                      String clientId, List<String> scopes);
     ...
     * @return 访问令牌
     */
    SystemOauth2AccessToken grantRefreshToken(String refreshToken, String clientId);
     ...
     * @return 访问令牌
     */
    SystemOauth2AccessToken grantClientCredentials(String clientId, List<String> scopes);
