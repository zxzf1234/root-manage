package com.xiyu.service.framework.job.core.scheduler;

import com.xiyu.service.framework.job.core.enums.JobDataKeyEnum;
import com.xiyu.service.framework.job.core.handler.JobHandlerInvoker;
import org.quartz.*;
...
public class SchedulerManager {
     ...
     */
    public void addJob(UUID jobId, String jobHandlerName, String jobHandlerParam, String cronExpression,
                       Integer retryCount, Integer retryInterval)
            throws SchedulerException {
        // 创建 JobDetail 对象
        JobDetail jobDetail = JobBuilder.newJob(JobHandlerInvoker.class)
                .usingJobData(JobDataKeyEnum.JOB_ID.name(), jobId.toString())
     ...
     */
    public void triggerJob(String jobId, String jobHandlerName, String jobHandlerParam)
            throws SchedulerException {
